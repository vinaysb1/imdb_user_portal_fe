      ...
      {movies.map((movie) => (
        <div key={movie.id}>
          ...
          <div>
            ...
            <button onClick={() => handleRating(movie.id, 2)}>Rate 2 star </button>
            <button onClick={() => handleRating(movie.id, 3)}>Rate 3 star </button>
            <button onClick={() => handleRating(movie.id, 4)}>Rate 4 star </button>
            <button onClick={() => handleRating(movie.id, 5)}>Rate 5 star </button>
          </div>
        </div>
      ))}
    </div>
